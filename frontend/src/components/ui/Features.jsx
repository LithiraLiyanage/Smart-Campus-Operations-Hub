        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, i) => (
            <motion.div
              ...
              whileHover={{ y: -6, boxShadow: "0 12px 40px rgba(37,99,235,0.14)" }}
              className={`bg-surface-container-low rounded-2xl p-6 border ${feature.accent} transition-all duration-300 cursor-default`}
            >
              <div
